...
import { FromTelegramAuthDto } from 'src/app/Balance/Contracts/Auth/FromTelegramAuthDto';
import { CommonDtoMapper } from 'src/app/Balance/Converters/CommonDtoMapper';
